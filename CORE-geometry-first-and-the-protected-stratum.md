...
- **Plank I — geometry is fundamental, and 4-dimensional.** The smooth 4-manifold — its metric and, crucially, its *diffeomorphism type* — is ontologically primitive; dimension 4 is *necessary*, because 4 is the unique dimension whose smooth structure is rich enough (exotic smoothness) to carry what others outsource to extra dimensions.
