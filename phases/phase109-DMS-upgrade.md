...
### A.6 Addendum (2026-07-27, post M-FRAME2 completion) — THE BINARY IS CLOSED; D-MS SELECTED

Both M-FRAME2 routes executed and refereed. Route (a): the compactified zero-mode representation was built and refereed (phases/phase117-ZM1-round1-construction.md A.1) — κ = ½ derived (theorem within zero-mode framing, R-independent), D-MS forced within that framing. Route (b): the crossing family at n ≠ 0 computed for a pair and kill-refereed (phases/phase118-MFRAME2b-crossing-pair.md A.1; reviews/REPORTS-phase118-MFRAME2b-referee-2026-07-27.md) — **the per-defect crossing totalization violates S4 on two independent legs (fusion anomaly nQ₁Q₂; fusion-free label degeneracy); framing-deleted ELIMINATED; the S4-consistent crossing scheme is cluster-scale and reproduces D-MS.** The two definitions of framing merge. **D_spin = ∓Q²/2 + nQ²/2 with mutual term M = (n∓1)Q₁Q₂ is now the DERIVED scheme of the record, not an adopted convention.** The C-D5-style full upgrade deferred in A.4 is hereby triggered. Residues carried: odd-n pair framing at δ > 0 constructively unexhibited (C-AC3); n is crossing-event data, not winding data (C-AC1); per-particle windings n₁ ≠ n₂ now live in the refereed zero-mode extension (phase 117 §(d)(i), C-S5 value ½(n₁+n₂)Q₁Q₂, GAP-6 ordering treatment pending in BIND-2(c)).
